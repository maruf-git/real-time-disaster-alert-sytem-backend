/**
 * seed.js — Fresh database setup for Real-time Disaster Alert System
 *
...
const DISASTERS = [
  {
    name: "Earthquake",
    description: "Seismic activity detected near the location.",
  },
  {
    name: "Flash Flood",
    description: "Sudden flooding caused by heavy rainfall or river overflow.",
  },
  {
    name: "Heatwave",
    description: "Extreme heat conditions dangerous to health.",
  },
  {
    name: "Cold Wave",
    description: "Extreme cold conditions dangerous to health.",
  },
  {
    name: "Air Pollution",
    description: "Hazardous air quality index levels affecting public health.",
  },
];
...
const RULES = [
  // Flash Flood — rain_sum (mm)
  {
    ...
    threshold: 10,
    severity: "Low",
    message: "Moderate rainfall — flash flood watch",
  },
  {
    disaster: "Flash Flood",
    condition: "rain_sum",
    ...
    threshold: 25,
    severity: "Medium",
    message: "Heavy rainfall — flash flood advisory",
  },
  {
    disaster: "Flash Flood",
    condition: "rain_sum",
    ...
    threshold: 50,
    severity: "High",
    message: "Very heavy rain — flash flood warning",
  },
  {
    disaster: "Flash Flood",
    condition: "rain_sum",
    ...
    threshold: 100,
    severity: "Critical",
    message: "Extreme rainfall — flash flood emergency",
  },
  // Heatwave — temperature (°C)
  {
    ...
    threshold: 36,
    severity: "Low",
    message: "Hot weather — heat advisory",
  },
  {
    disaster: "Heatwave",
    condition: "temperature",
    ...
    threshold: 38,
    severity: "Medium",
    message: "Heatwave conditions developing",
  },
  {
    disaster: "Heatwave",
    condition: "temperature",
    ...
    threshold: 40,
    severity: "High",
    message: "Severe heatwave — heat stroke risk",
  },
  {
    disaster: "Heatwave",
    condition: "temperature",
    ...
    threshold: 42,
    severity: "Critical",
    message: "Extreme heatwave — life-threatening",
  },
  // Cold Wave — temperature (°C)
  {
    ...
    threshold: 15,
    severity: "Low",
    message: "Cool conditions — cold watch",
  },
  {
    disaster: "Cold Wave",
    condition: "temperature",
    ...
    threshold: 10,
    severity: "Medium",
    message: "Cold wave — vulnerable groups at risk",
  },
  {
    disaster: "Cold Wave",
    condition: "temperature",
    ...
    threshold: 5,
    severity: "High",
    message: "Severe cold wave — frost risk",
  },
  {
    disaster: "Cold Wave",
    condition: "temperature",
    ...
    threshold: 2,
    severity: "Critical",
    message: "Extreme cold — hypothermia risk",
  },
  // Air Pollution — AQI (US index)
  {
    disaster: "Air Pollution",
    condition: "aqi",
    operator: ">=",
    threshold: 101,
    severity: "Low",
  ...
  },
  {
    ...
    threshold: 201,
    severity: "High",
    message: "Very unhealthy air — wear masks",
  },
  {
    disaster: "Air Pollution",
    condition: "aqi",
    ...
    threshold: 301,
    severity: "Critical",
    message: "Hazardous AQI — stay indoors",
  },
  // Earthquake — magnitude
  {
    disaster: "Earthquake",
    condition: "earthquake_magnitude",
    operator: ">=",
    threshold: 3.0,
    severity: "Low",
  ...
  },
  {
    ...
    threshold: 4.5,
    severity: "Medium",
    message: "Moderate earthquake — check for damage",
  },
  {
    disaster: "Earthquake",
    condition: "earthquake_magnitude",
    ...
    threshold: 5.5,
    severity: "High",
    message: "Strong earthquake — evacuate if unsafe",
  },
  {
    disaster: "Earthquake",
    condition: "earthquake_magnitude",
    ...
    threshold: 6.5,
    severity: "Critical",
    message: "Major earthquake — emergency response activated",
  },
];
...
async function run() {
  ...
  try {
    ...
    const [disasterRows] = await connection.query(
      "SELECT id, name FROM disasters",
    );
    const disasterMap = {};
    disasterRows.forEach((d) => {
      disasterMap[d.name] = d.id;
    });
    ...
    for (const rule of RULES) {
      ...
      if (!disasterId) {
        console.warn(`⚠ Disaster not found: ${rule.disaster}`);
        continue;
      }
      await connection.query(
